...
<head>
    ...
    <title>MyAirbnb Home</title>
    <link rel="stylesheet" href="${cssUrl}" type="text/css">
</head>

<body>
    <center><h3>Welcome to Airbnb Home Page</h3></center>

    <p align="right" <li><a href="admin.jsp">Admin</a>
    ...
    <ul class="navbar">
        <li type="disc"><a href="index">Airbnb Welcome page</a>
